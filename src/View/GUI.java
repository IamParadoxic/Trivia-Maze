...
public class GUI implements Serializable {
	...
	private final long serialVersionUID = -471174395510626265L;
	private TriviaMazeMain tmm;
	private JFrame window;
	private JTextArea messageText;
	private JPanel fieldPanel[] = new JPanel[10];
	private JLabel fieldLabel[] = new JLabel[10];
	private JMenuBar menuBar;
	private JMenu menu[] = new JMenu[10];
	...
	private int myRoomM = 1, myRoomN = 1;
	...
	public void setMyCurrentRoom(int m,int n) {
		myCurrentRoom = myGrid[myRoomM + m][myRoomN + n];
	}
	...
	public GUI(TriviaMazeMain tmm) {
		...
		createDoors();
		createMap();
		myCurrentRoom = myGrid[myRoomM][myRoomN];
	...
	private void generate(int theM, int theN) {
		...
		myGridLocation.setLocation(700, 500);
